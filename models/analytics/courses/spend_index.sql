...
final as (
  select
    ...
    b.spend as benchmark_spend,

    --student satisfation
    AVG(c.spend) as avg_competitor_spend,
    (b.spend*100.0/AVG(c.spend)) as avg_line_spend_index,
...
where competitor is not null
  and benchmark_spend is not null
  and avg_competitor_spend is not null
-- order by avg_line_spend_index desc
-- limit 10
